...
file_paths = [
    'data/critical_vaccination__N_4_0.6_efficacy_1_effintra_0.1alphastar.npy',
    'data/critical_vaccination__N_4_0.6_efficacy_0.5_effintra_0.1alphastar.npy',
    'data/critical_vaccination__N_4_0.6_efficacy_0.1_effintra_1alphastar.npy'
]
...
norm = TwoSlopeNorm(vmin=vmin, vcenter=0.35, vmax=vmax)
...
axes[0].set_xlabel('$h_2$', fontsize=20)
...
cb = fig.colorbar(mesh, cax=cbar_ax, norm = norm, label='Critical $\pi$')
...
# Save the figure
output_file = os.path.join(output_dir, 'cont_area_plot_same_colorbar_h2h4_vaccination_vert.pdf')
